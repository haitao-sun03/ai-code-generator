...
public class CodeFileSaverExecutor {
    ...
    public static File executeCodeFileSaver(Object content, CodeGenTypeEnum codeGenTypeEnum, Long appId) {
        return switch (codeGenTypeEnum) {
            case HTML -> HTML_FILE_SAVER.saveFile((HtmlCodeResult) content, appId);
            case MULTI_FILE -> MULTI_FILE_SAVER.saveFile((MultiFileCodeResult) content, appId);
            default -> {
