...
/** 此处后端没有提供注释 POST /user/isLogin */
export async function isLogin(options?: { [key: string]: any }) {
  return request<API.ApiResponseBoolean>('/user/isLogin', {
    method: 'POST',
    ...(options || {}),
  })
}
...
/** 此处后端没有提供注释 POST /user/login/user */
export async function getLoginUser(options?: { [key: string]: any }) {
  return request<API.ApiResponseLoginUserVO>('/user/login/user', {
    method: 'POST',
    ...(options || {}),
  })
}
...
export async function register(body: API.UserRegisterRequest, options?: { [key: string]: any }) {
  return request<API.ApiResponseLong>('/user/save', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
